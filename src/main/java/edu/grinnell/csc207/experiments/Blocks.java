...
public class Blocks {
  ...
  public static void main(String[] args) throws Exception {
    ...
    separator(pen);
    AsciiBlock.print(pen, new HorizontalCompositionTop(b7, b7));

    AsciiBlock comp1 = new HorizontalCompositionTop(exes, new HorizontalCompositionTop(ohs, exes));
    AsciiBlock comp2 = new HorizontalCompositionTop(new HorizontalCompositionTop(exes, ohs), exes);
    AsciiBlock boxedcomp = new Boxed(new HorizontalCompositionTop(ohs, exes));
